...
class MY_Model extends CI_Model {
	 ...
	 * $sql : câu lệnh spl phức tạp mà CI không cung cấp
	 */
	function query($sql){
	...
	/**
	 * Lấy thông tin của hàng theo điều kiện
	...
	{
		$this->db->select_sum($field);//tính tổng
		$this->db->where($where);//điều kiện
	...
	/**
	 * Gán các thuộc tính trong input khi lấy thuộc tính
	 * $input : mảng dữ liệu đầu vào
	 */
	...
	protected function get_list_set_input($input = array())
	{
		...
		//(ví du: $input['where'] = array('email' => 'hocphp@gmail.com'))
		...
		// Thêm điều kiện limit(giới hạn) cho câu truy vấn thông qua biến $input['limit'] 
    ...
    {
	    $this->db->where($where);
	    //thực hiện câu truy vấn để lấy dữ liệu
		$query = $this->db->get($this->table);
