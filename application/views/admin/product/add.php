...
<div class="wrapper">
	...
	<form enctype="multipart/form-data" method="post"
		action="<?= admin_url('product/add')?>" id="form" class="form">
		<fieldset>
			<div class="widget">
				<div class="title">
					<img class="titleIcon"
				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><input type="text" _autocheck="true"
									id="param_name" name="name"></span> <span class="autocheck"
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"> <input type="text" _autocheck="true"
									class="format_number" id="param_price" style="width: 100px"
									name="price"> <img
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span> <input type="text" class="format_number"
						...
						<div class="formRow">
							...
							<div class="formRight">
								...
								<div class="clear error" name="hot_product_error"></div>
							</div>
							<div class="clear"></div>
						</div>
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4" id="param_content_decrip"
										name="content_decrip"></textarea></span> <span class="autocheck"
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4" id="param_gifts"
										name="gifts"></textarea></span> <span class="autocheck"
									name="sale_autocheck"></span>
					...
					<div class="tab_content pd0" id="tab2" style="display: none;">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4"
										_autocheck="true" id="param_site_title" name="site_title"></textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4"
										_autocheck="true" id="param_meta_desc" name="meta_desc"></textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4"
										_autocheck="true" id="param_meta_key" name="meta_key"></textarea></span>
				...
				<div class="formSubmit">
					<input type="submit" class="redB" value="Thêm mới"> <input
