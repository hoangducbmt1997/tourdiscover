				...
				<div class="tab_container">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
									...
									id="param_name" value="<?= $news->title?>" name="title"></span> <span class="autocheck"
						...
						<div class="formRow">
							...
							<div class="formRight">
								<div class="left">
                                    ...
                                    <br/>
                                    <img src="<?= base_url('public/upload/news/'.$news->image_link)?>" style=" width:100px;height:70px;margin:15px 0px 0px 0px ">
								</div>
					...
					<div class="tab_content pd0" id="tab2" style="display: none;">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4"
										_autocheck="true" id="param_meta_desc" name="meta_desc"><?= $news->meta_desc?></textarea></span>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"><textarea cols="" rows="4"
										_autocheck="true" id="param_meta_key" name="meta_key"><?= $news->meta_key?></textarea></span>
					...
					<div class="tab_content pd0" id="tab3" style="display: none;">
						<div class="formRow">
							...
							<div class="formRight">
								<textarea class="editor" id="editor" name="content"><?= $news->content?></textarea>
