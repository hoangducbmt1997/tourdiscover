	...
	<div class="widgets">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="sTable myTable">
					<tbody>
						<tr>
							...
							<td class="textR webStatsLink red" style="width: 120px;">44,000,000
								đ</td>
						</tr>
						<tr>
					...
					<tbody>
						...
						<tr>
							<td>
								...
								<div class="right f11">
									<a href="admin/product.html">Chi tiết</a>
								</div>
							</td>
						...
						<tr>
							<td>
								...
								<div class="right f11">
									<a href="admin/news.html">Chi tiết</a>
								</div>
							</td>
						...
						<tr>
							<td>
								...
								<div class="right f11">
									<a href="admin/user.html">Chi tiết</a>
								</div>
							</td>
						...
						<tr>
							<td>
								...
								<div class="right f11">
									<a href="admin/contact.html">Chi tiết</a>
								</div>
							</td>
		...
		<div class="widget">
			...
			<table cellpadding="0" cellspacing="0" width="100%"
				...
				<tbody class="list_item" align="center">
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/21.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/21.html" title="Xóa"
					...
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/20.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/20.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/19.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/19.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/18.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/18.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/17.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/17.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/16.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/16.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/15.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/15.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/14.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/14.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/13.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/13.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
					<tr>
						...
						<td class="textC"><a href="admin/tran/view/12.html"
							class="lightbox"> <img src="<?php echo public_url('admin')?>/images/icons/color/view.png">
						</a> <a href="admin/tran/del/12.html" title="Xóa"
							class="tipS verify_action"> <img
								src="<?php echo public_url('admin')?>/images/icons/color/delete.png">
						</a></td>
					</tr>
