...
<p class="title-cat-list-content-product-tour">Home / Search Results </p>
	<div class="form-search-tour">
		<h3 class="title-cat-list-content-product-tour-bold">Search Results</h3>
		<form class="form_action-search-tour" method="get" style="padding:10px" action="<?= site_url('product/search_price') ?>" name="search">
